...
- dialog:
  ...
  - text: "| react-essentials#server-components | | ,-[/Users/notiseoton2/Desktop/SiteAris/lib/supabase/chat-support.ts:5:1] 5 | 6 | import { createClient } from '@/lib/supabase/client'; 7 | import { createServerComponentClient } from '@/lib/supabase/helpers'; 8 | import { cookies } from 'next/headers'; : ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ 9 | import { v4 as uuidv4 } from 'uuid'; 10 | 11 | export type ChatMessage = { `---- Import trace for requested module:"
  - link "./lib/supabase/chat-support.ts":
    - text: ./lib/supabase/chat-support.ts
    - img
  - link "./components/chat/chat-support-widget.tsx":
    - text: ./components/chat/chat-support-widget.tsx
    - img
  - contentinfo:
